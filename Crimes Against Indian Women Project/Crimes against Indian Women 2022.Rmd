---
title: "Crimes Against Indian Women Project (2022)"
...
##Introduction
This report analyzes crimes committed against women and girl children in India in 2022, using data from the National Crime Records Bureau and scraped data fro statisticstimes.com. The goal was to identify patterns, high-risk regions, and key issues that need urgent attention. This dataset contains the number of cases registered across all Indian states/ UTs against the crimes committed against women (includes adults and minors) that are recognizable within the Indian Penal Code.
...
##Conclusion
This analysis reveals patterns in crime distribution, key danger zones, and emerging forms of abuse such as Rape and child exploitation. These insights can inform prevention policies and help focus awareness campaigns.
